        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-success">
                    ...
                    <form method="POST" role="form" enctype="multipart/form-data" action="{{url('/barang-masuk')}}">
                        @csrf
                        <div class="card-body">
                ...
                <div class="card card-warning">
                    ...
                    <form method="POST" role="form" enctype="multipart/form-data" action="{{url('/import-barang-masuk')}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                            ...
                            <a href="{{asset('templateexcel/template_barang_masuk.xlsx')}}" class="btn btn-info">Download Template Import</a>
                        </div>
                        <div class="card-footer">
