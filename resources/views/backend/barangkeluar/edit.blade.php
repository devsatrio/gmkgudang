            ...
            <div class="col-12">
                ...
                <div class="card card-warning">
                    <div class="card-header">
                        ...
                        <span>NB : Mengedit Data Barang Keluar Tidak Akan Berpengaruh Pada Stok Barang</span>
                    </div>
                    @foreach($data as $row)
                    <form method="POST" role="form" enctype="multipart/form-data" action="{{url('/barang-keluar/'.$row->id)}}">
                        @csrf
